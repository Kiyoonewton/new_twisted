...
import { getMetadataDetails, getOpengraphMetaData, getTwitterMetaData } from "@/helpers/seo";
import Meta from "./Meta";

const HeadTags = (props:LayoutArticleProps) => {
    const meta = getMetadataDetails({ ...props.page }, props.meta);
    const facebookMetaData = getOpengraphMetaData({ ...props.facebook, ...props.page }, props.meta);
    const twitterMetaData = getTwitterMetaData({ ...props.twitter, ...props.page }, props.meta);
    return (
        <Head>
            {/* Title */}
            ...
            <meta
                ...
                content="-pzdb6DWUgyq3kHneX8K8QjeCl9kHSc4IQM9H6i_-M4"
            />
